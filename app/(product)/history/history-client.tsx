  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        {filteredPacks.length > 0 && (
          <div className="grid grid-cols-[minmax(0,1fr)_90px_80px_24px] items-center gap-6 px-2 text-xs uppercase tracking-[0.2em] text-neutral-400">
            <span>Pack</span>
        ...
        {filteredPacks.map((pack) => (
          ...
          >
            <div className="grid grid-cols-[minmax(0,1fr)_90px_80px_24px] items-center gap-6 px-6 py-5">
              ...
              <span className="justify-self-start rounded-full bg-[#EEE9FF] px-3 py-1 text-xs font-medium text-[#4F46E5]">
                {pack.planAtGeneration}
              </span>
