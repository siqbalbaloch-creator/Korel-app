...
export default function NewPackPage() {
  ...
  // ?t= is set by the sidebar "New Pack" button to force a fresh session
  ...
  // Pre-fill only — does NOT trigger auto-generation
  useEffect(() => {
    if (!prefillInput) return;
    setSourceInput((current) => (current.trim() ? current : prefillInput));
  }, [prefillInput]);

  // Reset page state when the sidebar "New Pack" button sends a fresh ?t= token
  useEffect(() => {
            ...
            >
              {isGenerating ? (
                <>
                  ...
                  <span>Generating Authority Pack…</span>
                </>
              ) : (
                <>
