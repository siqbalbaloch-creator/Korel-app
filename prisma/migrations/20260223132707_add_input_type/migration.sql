...
INSERT INTO "new_AuthorityPack" ("coreThesis", "createdAt", "executiveSummary", "highLeveragePosts", "id", "insightBreakdown", "lastGeneratedAt", "originalInput", "published", "publishedAt", "qualityBreakdown", "qualityScore", "regenerationCount", "repurposingMatrix", "status", "strategicHooks", "title", "userId") SELECT "coreThesis", "createdAt", "executiveSummary", "highLeveragePosts", "id", "insightBreakdown", "lastGeneratedAt", "originalInput", "published", "publishedAt", "qualityBreakdown", "qualityScore", "regenerationCount", "repurposingMatrix", "status", "strategicHooks", "title", "userId" FROM "AuthorityPack";
